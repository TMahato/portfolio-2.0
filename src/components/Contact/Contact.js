...
export default function Contact() {
  ...
  const email = "mahatotanmay99@gmail.com";
  const phone = "+91 8670896399";
  const github = "github.com/TMahato";
  const linkedin = "https://www.linkedin.com/in/tanmay-mahato-2aaa25201/";
  const leetcode = "leetcode.com/tanmay_212";
            ...
            <ContactSC.ContactItem className="item-container">
              ...
              <ContactSC.ContactItemDetails className="item-details">
                ...
                <ContactSC.ContactItemLink
                  ...
                  href="https://www.linkedin.com/in/tanmay-mahato-2aaa25201/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {linkedin}
            ...
            <ContactSC.ContactItem className="item-container">
              ...
              <ContactSC.ContactItemDetails className="item-details">
                ...
                <ContactSC.ContactItemLink
                  className="item-span"
                  id="gitHub-contact-span"
                  href="https://leetcode.com/tanmay_212/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {leetcode}
